...
1. **Descargue** el archivo [**`Goog_API.tar.gz`**]()
...
**Recibe:**
* **INT `ano` :** Entero que representa el año de la fecha de inicio del evento.
* **INT `mes` :** Entero que representa el mes de la fecha de inicio del evento.
* **INT `dia` :** Entero que representa el día de la fecha de inicio del evento.
* **STR `hora_inicio` :** Cadena de caracteres que representa la hora de inicio del evento **en formato HH:MM.**
* **STR `duracion` :** Cadena de caracteres que representa la duración del evento **en formato HH:MM.**
